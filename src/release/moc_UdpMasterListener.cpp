...
void UdpMasterListener::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        UdpMasterListener *_t = static_cast<UdpMasterListener *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (UdpMasterListener::*_t)();
        ...
        {
            typedef void (UdpMasterListener::*_t)(int );
...
QT_INIT_METAOBJECT const QMetaObject UdpMasterListener::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_UdpMasterListener.data,
      qt_meta_data_UdpMasterListener,  qt_static_metacall, nullptr, nullptr}
};
